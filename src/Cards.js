...
function Cards() {
   ...
   const [cards, setCards] = useState([]);
    ...
    const createClickableImage = (onClick,imgUrl,altText) => {
        return (
            <button  onClick={onClick}  style={{ width: "50px", height: "50px" ,margin:"5px", padding: "0",background:"transparent" }}>
                <img src={imgUrl} alt={altText} style={{ width: "100%", height: "100%" , objectFit: "cover" , backgroundColor: "transparent" }} />
            </button>
        )
    }
